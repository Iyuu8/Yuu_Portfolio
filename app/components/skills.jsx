...
export default function Skills() {
  ...
  return (
    <section className='min-h-screen  px-[1rem] flex flex-col gap-[clamp(1rem,5vw,4rem)] pt-[1rem]'>
        <h1 className='text-[var(--strong-red)] font-bold text-[clamp(36px,4.6vh,55px)]'>My Skills</h1>
