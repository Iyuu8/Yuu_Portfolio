...
export default function Contacts() {
  return (
    <footer id="Contact" className='bg-[var(--strong-red)] text-[var(--background)] flex flex-col items-center gap-[1rem] py-[1.5rem]'>
      ...
      <p className='text-center font-bold text-[clamp(15px,2vh,40px)] px-[0.5rem] hidden md:block'>Whether you have an idea in mind or want to build something amazing together — let’s connect!</p>
      <div className='flex w-[90%] text-[5vh] gap-[10%] grow-1 items-center justify-center'>
